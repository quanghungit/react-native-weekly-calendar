          ...
          >
            <View style={styles.dayLabel}>
              <Text
                style={[
                  styles.dayText,
                  { color: check ? "#F08704" : props.themeColor },
                ]}
              >
                {convert}
              </Text>
              ...
              >
                {weekdayToAdd.format("DD/MM").toString()}
              </Text>
            </View>
            <View
              style={[
            ...
            <View
              style={
                isCalendarReady && isSelectedDate(weekdays[0])
                  ? [styles.weekDayNumberCircle, { backgroundColor: "#F08704" }]
                  : {}
              }
            >
              <Text
                style={
                  isCalendarReady && isSelectedDate(weekdays[0])
                    ...
                    : { color: "#333333", fontSize: 14, marginTop: -8 }
                }
              >
                ...
                <View
                  style={
                    isSelectedDate(weekdays[0])
                      ? [styles.dot, { backgroundColor: props.colorDot }]
                      : [styles.dot, { backgroundColor: props.colorDot }]
                  }
                />
              )}
